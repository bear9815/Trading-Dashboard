import { LayoutDashboard, List, ShieldAlert, BarChart2, BookOpen, Settings, Sparkles, ScanLine, Sun, GitCompare, Layers, Globe, Trophy, Bot, PanelLeftClose, PanelLeftOpen, CandlestickChart, Bookmark } from 'lucide-react'
